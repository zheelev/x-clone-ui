...
const ImageEditor = ({
  ...
  return (
    <div className="fixed w-screen h-screen left-0 top-0 bg-black opacity-98 z-10 flex items-center justify-center">
      <div className="bg-black rounded-xl p-12 flex flex-col gap-4">
        ...
        {/* IMAGE CONTAINER */}
        <div className="w-[600px] h-[600px] flex items-center opacity-75">
          <Image
            src={previewURL}
            alt=""
            width={600}
