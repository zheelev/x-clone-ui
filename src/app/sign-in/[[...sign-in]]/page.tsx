        ...
        <SignIn.Root>
          ...
          <SignIn.Step name="start">
            <Clerk.Field name="identifier" className="flex flex-col gap-2">
              <Clerk.Input placeholder="johndoe@gmail.com"
          ...
          <SignIn.Step name="verifications">
            <SignIn.Strategy name="password">
              ...
              <div className="flex flex-col gap-2">
                <SignIn.Action
                  submit
                  className="mt-2 text-sm underline w-72 text-center text-blue-500"
                >
                  Continue
                </SignIn.Action>
                <SignIn.Action
          ...
          >
            <SignIn.SupportedStrategy name="reset_password_email_code">
              <span className="underline text-blue-500">Reset password</span>
          ...
          <SignIn.Step name="reset-password">
            <h1 className="text-lg mb-3">Reset your password</h1>

            <Clerk.Field name="password">
              <Clerk.Label>New password</Clerk.Label>
              <Clerk.Input className="ml-2" />
              <Clerk.FieldError className="text-red-300 text-sm" />
            </Clerk.Field>
            ...
            <SignIn.Action submit className="cursor-pointer">Reset password</SignIn.Action>
          </SignIn.Step>
          {/* OR SIGN UP */}
          ...
          <p className="w-72 text-xs cursor-pointer">
            By signing up, you agree to the <span className="text-blue-500">Terms of Service</span> and <span className="text-blue-500">Privacy Policy</span>,
